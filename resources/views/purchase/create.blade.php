...
$("#save-btn").click(function(){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            markup = '<tr id="article_'+data.data.legacyArticleId+'"><td>'+ data.data.genericArticleDescription +'-'+ data.data.articleNumber + '</td><td><input type="number" class="form-control" name="black_qty[]" value="0" min="0" onkeyup="alterBlackQty('+data.data.legacyArticleId+')" id="black_qty_'+data.data.legacyArticleId+'" required></td><td><input type="number" class="form-control" onkeyup="alterWhiteQty('+data.data.legacyArticleId+')" id="white_qty_'+data.data.legacyArticleId+'" value="0" min="0" name="white_qty[]" required></td><td><input type="number" class="form-control" value="0" min="0" id="purchase_price_'+data.data.legacyArticleId+'" name="purchase_price[]" required></td><td><input type="number" class="form-control" value="0" min="0" id="sale_price_'+data.data.legacyArticleId+'" name="sale_price[]" required></td><td><input type="number" class="form-control" value="0" min="0" name="total_price[]" required></td><td><i id="article_delete_'+data.data.legacyArticleId+'" onclick="deleteArticle('+data.data.legacyArticleId+')" class="fa fa-trash"></i></td><td style="display:none;">'+html+'</td></tr>';
                if(length <= 1){
