                    ...
                    <div class="card-body">
                        <div class="container">
                            <div class="d-flex flex-row-reverse mb-3 mr-4">
                                <a href="{{route('suppliers.create')}}" class="btn btn-info mb-1"><i class="dripicons-plus"></i> {{trans('file.Add Supplier')}}</a>
            ...
            headers: {
                ...
                $('#data-table').DataTable({
                    ...
                    columns: [
                        ...
                        {"data": "brandLogoID",  name: 'brandLogoID'},
                        {"data": "brandName",  name: 'brandName'},
                        {"data": "lang",  name: 'lang'},
                        {"data": "articleCountry",  name: 'articleCountry'},
                        {
                            "data": 'action',
                            name: 'action',
                            orderable: false,
