...
<div class="card-body">
    ...
    @endif
    <form action="{{route('articleCriteria.update', $art_criteria->id)}}" method="post" id="criteriaForm" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <h6>Criteria Type</h6>
                            <input type="text" name="criteriaType" id="criteriaType" class="form-control" value="{{$art_criteria->legacyArticleId}}" maxlength="5" required>
                        </div>
                    </div>
                    <div class="col-4">
                        <h6>Value Key Id</h6>
                        <select name="valueKeyId" id="valueKeyId" class="form-control">
                            ...
                            <option value="{{ $keyValue->keyId }}" {{ $keyValue->keyId == $art_criteria->valueKeyId ? "selected" : ""}}>
                                {{ $keyValue->keyValue }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="d-flex flex-row-reverse">
                    <button type="button" class="btn btn-success" id="submitCriteria" style="width:100px">Update</button>
                    ...
                    success: function(response) {
                        if (response.data.id) {
                            ...
                            if (legacy_id != null) {
                                ...
                                document.getElementById('ArticleCrteria').style.display = "none";
                                ...
                                document.getElementById('ArticleCrosses').style.display = "block";
