                ...
                <div class="mt-4">
                    ...
                    <div class="text-95 text-secondary-d3">
                        ...
                        <div class="row mb-2 mb-sm-0 py-25">
                            ...
                            <div class="col-2 text-secondary-d2">${{$product->price * $product->qty}}</div>
                        </div>
                        @php
                        $i++;
                        @endphp
            ...
            -->
                    ...
                    <hr style="border: 2px solid black;opacity:1">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-5">
                                    <span class="text-110 text-secondary-d1">${{$sale->shopping_cost}}</span>
                                </div>
                            </div>
...
<footer>
    <div class="row p-2">
        ...
        <div class="col-6 mr-2" align="right">
            <a href="{{route('sales.edit',$sale->id)}}" class="btn btn-primary">Update</a>
            <a href="{{route('sales.approveEstimate',$sale->id)}}" class="btn btn-success">Approve</a>
        </div>
    </div>
</footer>
