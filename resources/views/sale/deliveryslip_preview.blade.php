                ...
                <div class="row">
                    ...
                    <div class="text-95 col-sm-5 offset-2">
                        ...
                        <div class="text-black-m2">
                            ...
                            <div>
                                <span class="">Document Date : </span>{{$deliveryslip->created_at->format('d-m-Y')}}
                            </div>
                            <div>
            ...
            -->
                    ...
                    <!-- <hr style="border: 2px solid black;opacity:1"> -->
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-5">
                                    @if($sale != null)
                                    <span class="text-120 text-secondary-d1">${{$sale->order_discount}}</span>
                                    @elseif($invoice != null)
                                    <span class="text-120 text-secondary-d1">${{$invoice->order_discount}}</span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-5">
                                @if($sale != null)
                                    <span class="text-120 text-secondary-d1">${{$sale->order_tax}}</span>
                                    @elseif($invoice != null)
                                    <span class="text-120 text-secondary-d1">${{$invoice->order_tax}}</span>
                                @endif
                                </div>
                            </div>
                            <div class="row mt-2">
                                ...
                                <div class="col-5">
                                @if($sale != null)
                                    <span class="text-120 text-secondary-d1">${{$sale->shipping_cost}}</span>
                                    @elseif($invoice != null)
                                    <span class="text-120 text-secondary-d1">${{$invoice->shipping_cost}}</span>
                                @endif
                                </div>
                            </div>
                            ...
                            <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                ...
                                <div class="col-5">
                                    @if($sale != null)
                                    <span class="text-120 text-secondary-d1">${{$sale->grand_total}}</span>
                                    @elseif($invoice != null)
...
<footer style="position: fixed;bottom: 0;height: 75px;width:100%;background: white;border-top: 5px solid #6699cc;">
    <div class="row p-2">
        <div class="col-6">
            <h1><i class="bi bi-file-earmark-text"></i><i class="fa-solid fa-file-lines"></i> Delivery Slip</h1>
        </div>
        <div class="col-6">
            <a href="{{route('sales.deliveryslips')}}" class="btn btn-primary">Return</a>
        </div>
    </div>
</footer>
