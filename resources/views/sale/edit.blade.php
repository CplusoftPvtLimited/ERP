                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                @if ($sale->cash_type == 'white')
                                                    <input type="text" class="form-control" value="White Cash" readonly>
                                                @else
                                                    <input type="text" class="form-control" value="Black Cash" readonly>
                                                @endif
                                                ...
                                                @foreach ($sale_products as $sale_product)
                                                    @if ($sale->cash_type == 'white')
                                                        <tr id="item_row_"{{$sale_product->id}}>
                                                            ...
                                                            <td>
                                                                <input class="form-control" type="number" step="any"
                                                                    id="discount_{{ $sale_product->id }}" name="discount[]"
                                                                    onkeyup="editSaleQty({{ $sale_product->id }})"
                                                                    value="{{ $sale_product->discount }}">
                                                            </td>
                                                            <td>
                                                                <input class="form-control" type="number" step="any"
                                                                    id="vat_{{ $sale_product->id }}" name="vat[]"
                                                                    value="{{ $sale_product->vat }}">
                                                            </td>
                                                            <td>
                                                                <input class="form-control" type="number" step="any"
                                                            ...
                                                            <td><i id="article_delete" onclick="deleteSaleArticleItem({{$sale_product->id}})" class="fa fa-trash"></i></td>
                                                        </tr>
                                                    @endif
                                                @endforeach
                                    ...
                                    <div class="row total-calculations">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" name="sale_entire_total_exculding_vat"
                                                ...
                                                value="{{ $sale->sale_entire_total_exculding_vat }}" class="form-control"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="row total-calculations">
                                    ...
                                    <div class="row total-calculations">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" name="entire_vat" value="{{ $sale->entire_vat }}"
                                                min="1" onkeyup="calculateEditSaleTotal()" id="sale_entire_vat"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="row total-calculations">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" name="tax_stamp" id="sale_tax_stamp"
                                                onkeyup="calculateEditSaleTotal()" class="form-control" min="0"
                                                value="{{ $sale->tax_stamp }}" step="any">
                                        </div>
                                    </div>
                                    <div class="row total-calculations">
                                        <div class="col-md-4">
    ...
    <script type="text/javascript">
        ...
        if (product_ids.length > 0) {
            ...
            function getActualProductCost(id, index) {
                    ...
                    total_before_discount += (parseInt($('#sale_item_qty_' + id).val()) * parseFloat($('#sale_price_' + id).val()));
            }
