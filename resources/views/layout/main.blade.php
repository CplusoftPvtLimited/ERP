...
<body onload="myFunction()">
            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">
                    ...
                    <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i
                        ...
                        <ul id="sale" class="collapse list-unstyled ">
                            ...
                            <li id="invoices-list-menu"><a
                                    href="{{ route('sales.salesInvoices') }}">{{ trans('file.Invoice List') }}</a>
                            </li>
                            <li id="pre-invoices-list-menu"><a href="">{{ trans('file.Delivery Slips') }}</a>
                            </li>
                ...
                <li><a href="#accounting" aria-expanded="false" data-toggle="collapse"> <i
                    ...
                    <ul id="accounting" class="collapse list-unstyled ">
                        ...
                        <li id="accounting-list-menu" class="{{ $route == 'cash.management.cheque' ? 'active' : '' }}"><a
                                href="{{ route('cash.management.cheque') }}"> {{ trans('file.Check And Drafts') }}</a></li>
                    </ul>
                </li>
    ...
    @if ($index_permission_active)
        ...
        <ul id="quotation" class="collapse list-unstyled ">
            ...
            <li id=""><a href="{{ route('preinvoices.index') }}">{{ trans('file.Pre Invoice List') }}</a>
            </li>
